...
const BASE = {
  ...
  OpenTime: '2024.06.15 13:30:00', CloseTime: '2024.06.15 14:00:00',
...
describe('mapMtConnectTrade', () => {
  it('maps a BUY deal', () => {
    ...
    expect(t.sessionLabel).toBe('new_york') // 13:30 UTC = 09:30 NY (EDT, UTC-4)
  })
  ...
  it('classifies win / be / loss correctly', () => {
    ...
    // profit 5 + commission -20 = -15, within ±50 threshold
    expect(mapMtConnectTrade({ ...BASE, Profit: '5', Commission: '-20' }, 'x').classification).toBe('be')
  })
